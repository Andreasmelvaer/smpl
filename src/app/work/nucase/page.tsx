    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Image 
                src="/images/nucase/soda-can-hero.jpg"
                alt="Nucase Hero"
                width={847}
                height={167}
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative">
              <div className="transform rotate-3">
                <Image 
                  src="/images/nucase/home-screen-ui.jpg"
                  alt="Home Screen UI"
                  width={576}
                  height={324}
            ...
            <div className="space-y-6">
              <div className="transform -rotate-2">
                <Image 
                  src="/images/nucase/modal-beaver.png"
                  alt="Modal Beaver"
                  width={292}
                  height={300}
                  className="w-full h-auto rounded-3xl shadow-xl"
              ...
              <div className="transform rotate-1">
                <Image 
                  src="/images/nucase/modal-entrance.jpg"
                  alt="Modal Entrance"
                  width={292}
                  height={300}
                  className="w-full h-auto rounded-3xl shadow-xl"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="relative inline-block">
            <Image 
              src="/images/nucase/building-box.jpg"
              alt="3D Building Model"
              width={847}
              height={476}
              className="w-full max-w-2xl h-auto rounded-3xl shadow-xl mx-auto"
            />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative">
              <div className="transform -rotate-2">
                <Image 
                  src="/images/nucase/screen-ui-2.jpg"
                  alt="Screen UI 2"
                  width={576}
                  height={324}
                  className="w-full h-auto rounded-3xl shadow-xl"
            ...
            <div className="space-y-6">
              <div className="transform rotate-1">
                <Image 
                  src="/images/nucase/beaver-nap.jpg"
                  alt="Beaver Nap"
                  width={292}
                  height={300}
                  className="w-full h-auto rounded-3xl shadow-xl"
              ...
              <div className="transform -rotate-1">
                <Image 
                  src="/images/nucase/can-we-fix-it.jpg"
                  alt="Can We Fix it? Yes We Can!"
                  width={292}
                  height={300}
                  className="w-full h-auto rounded-3xl shadow-xl"
                />
      ...
      <section className="relative bg-gradient-to-br from-[#B8F542] to-[#9EE62F] py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="relative inline-block">
            <Image 
              src="/images/nucase/phone-mockup.jpg"
              alt="Phone Mockup"
              width={600}
              height={360}
              className="w-full max-w-2xl h-auto rounded-3xl shadow-2xl mx-auto"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-4">
              <Image 
                src="/images/nucase/petter-stoldal.png"
                alt="Petter Støldal Profile Picture"
                width={64}
                height={64}
