              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
                <tr>
                  <td style="background-color: #141416; border-radius: 100px;">
                    <a href="https://smpl.as/downloads/ai-integration-playbook.pdf" style="display: inline-block; padding: 14px 32px; color: #ffffff; font-size: 14px; font-weight: 600; text-decoration: none;">Download the Playbook</a>
                  </td>
                </tr>
              </table>
...
function notificationEmailHtml(name: string, email: string, company: string | undefined, stage: string | undefined, wantsConsultation?: boolean) {
  return `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
          ...
          <tr>
            <td style="background-color: #ffffff; padding: 40px; border-radius: 0 0 16px 16px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                <tr>
                  <td style="padding: 12px 16px; background-color: #f5f5f0; border-radius: 10px;">
                    <p style="margin: 0 0 2px; font-size: 11px; letter-spacing: 1px; text-transform: uppercase; color: #999; font-weight: 600;">Stage</p>
                    <p style="margin: 0; font-size: 14px; color: #555;">${escapeHtml(stage)}</p>
                  </td>
                </tr>
              </table>` : ''}
              ${wantsConsultation ? `
              ...
              <p style="margin: 0; font-size: 14px; color: #555;">Downloaded the AI Integration Playbook from <a href="https://smpl.as/ai-playbook" style="color: #141416;">smpl.as/ai-playbook</a></p>
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (wantsConsultation) descParts.push('Wants a free AI strategy call')
    ...
    console.error('AI playbook form error:', error)
    return NextResponse.json(
