          ...
          <tr>
            <td style="background-color: #141416; padding: 32px 40px; border-radius: 16px 16px 0 0;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr><td style="padding-top: 24px;"><p style="margin: 0; font-size: 11px; letter-spacing: 2px; text-transform: uppercase; color: #c8ff00; font-weight: 600;">Build Guide</p></td></tr>
                ...
                <tr>
                  <td style="padding: 24px; background-color: #f5f5f0; border-radius: 12px;">
                    <p style="margin: 0 0 12px; font-size: 14px; line-height: 1.6; color: #555;">
                      Want help building your own tools? We offer free consultations.
                    </p>
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background-color: #141416; border-radius: 100px;">
                          <a href="https://smpl.as/contact" style="display: inline-block; padding: 10px 24px; color: #ffffff; font-size: 13px; font-weight: 600; text-decoration: none;">Book a Free Consultation</a>
                        </td>
                      </tr>
                    </table>
                  </td>
        ...
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
          <tr>
            <td style="background-color: #141416; padding: 32px 40px; border-radius: 16px 16px 0 0;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr><td>${logoWhite}</td></tr>
                <tr><td style="padding-top: 24px;"><p style="margin: 0; font-size: 11px; letter-spacing: 2px; text-transform: uppercase; color: #c8ff00; font-weight: 600;">New Lead — Build Guide</p></td></tr>
