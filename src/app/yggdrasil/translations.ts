...
export const sliderCommentary = {
  ...
  motion: {
    no: [
      ...
      'Spring/bounce. Du har for mykje energi og alle rundt deg e slitne.',
      'Total sirkus. Du er eit menneskeleg ADHD-fyrverkeri og eg elske det.',
    ],
    en: [
...
export const archetypes: Record<Locale, Record<ArchetypeKey, ArchetypeData>> = {
  no: {
    neurotic: {
      name: 'Den Nevrotiske Piksel-Tellaren',
      tagline: 'E den 1px ute? Ja. Ja, det e den.',
      description:
        'Du har zooma inn te 6400% fleire gangar enn du har ringt mamma. Du dør på haugen av optisk justering, og ærlig talt? Den haugen ser fantastisk kerna ut. Figma-filene dine e plettfrie. Fristane dine e ein vits.',
      diagnosis: 'Terminal kerning-angst med kronisk piksel-dysmorphia',
      strength: 'Håndverk som får andre designarar te å grina i stillheit',
      weakness: 'Har aldri levert noko før universet kollapsar',
      prescription: 'Gå ut. Ta på gras. Pikslane e der når du kjem tilbake.',
    },
    imposter: {
      name: 'Bedragaren Som Leverar',
      tagline: 'Eg aner ikkje ka eg gjer og det funke kver gong.',
      description:
        'Du falt inn i design fordi någen sa \"du har god smak\" og nå e du her, 4 år inn, og krangle om border-radius. Du lærte Figma på YouTube. Ditt første designsystem va eit Google Docs. Du e på ein eller annan måte den beste designaren på teamet og du aner ikkje korfor.',
      diagnosis: 'Kronisk imposter-syndrom med paradoksal kompetanse',
    ...
    helvetica: {
      name: 'Helvetica-Supremasisten',
      tagline: 'Ein font. Ein font lødde alt.',
      description:
        'Du trur typografi nådde toppen i 1957 og alt etter det e støy. Du har ein t-skjorte med Helvetica på. Du har FLEIRE t-skjorter med Helvetica på. Når någen bruke Comic Sans dør ein liten del av deg. Den delen veks aldri tilbake.',
      diagnosis: 'Monotypografisk besettelse med akutt font-intoleranse',
    ...
    gridDictator: {
      ...
      description:
        'Du har namngitt kvar einaste nyanse av grått. To gangar. Du skreiv eit 47-siders dokument om knapp-tilstandar og kjente berre glede. Du ser ein uautorisert border-radius og auget ditt ristje. Du trur på systemet. Systemet e alt.',
    ...
    chaotic: {
      name: 'Den Kaotiske Kreative',
      tagline: 'Grid? Aldri hørt om det.',
      description:
        'Ingen grid. Ingen reglar. Ingen lagra filer. Du designar som du lever — farleg og uorganisert. Moodboarda dine har moodboard. Du har ein gong beskrive ein knapp som \"emosjonelt utilgjengelig\". Stakeholdarar elske presentasjonane dine. Utviklare vil ha deg arrestert.',
      diagnosis: 'Kreativ kaos-forstyrring med anti-autoritær layout-tendens',
    ...
    hoarder: {
      name: 'Den OCD Komponent-Samlaren',
      tagline: 'Det der e ikkje i komponentbiblioteket.',
      description:
        'Du har 847 komponentar i Figma-biblioteket ditt. 12 av dei e i bruk. Du har variantar av variantar. Du har auto-layout inni auto-layout inni auto-layout. Filene dine e arkitektoniske meisterverk som ingen tør å røra.',
      diagnosis: 'Komponent-hoarding med kronisk over-engineering',
      strength: 'Designsystemet ditt e eit kunstwerk',
      weakness: 'Brukar 4 timar på å laga ein komponent ingen ba om',
      prescription: 'Slett ein komponent. Berre ein. Sjå ka som skjer. Hint: ingenting.',
    },
    awkward: {
      name: 'Den Sosialt Akavetne Handverkaren',
      tagline: 'Eg kommuniserar utelukkande gjennom Figma-kommentarar.',
      description:
        'Du snakke ikkje i møter. Du nikke, tar notat, og gjer akkurat det du vil etterpå uansett. Designa dine e fantastiske. Presentasjonane dine e eit krigsområde. Du har sagt \"kan du berre sjå på Figma-fila\" minst 400 gangar.',
      diagnosis: 'Sosial designar-angst med selektiv kommunikasjonsforstyrring',
      strength: 'Lagar ting som er so bra at folk gløyme at du aldri snakka i møtet',
      weakness: 'Har sendt ein Figma-lenke som svar på \"korleis har du det?\"',
      prescription: 'Sei ein ting i neste møte. Kva som helst. \"Fin knapp\" tel.',
    },
    notDesigner: {
      name: '\"Eg E Eigentleg Ikkje Ein Designar\"',
      tagline: 'Eg sko bli utviklar.',
      description:
      ...
      diagnosis: 'Identitetsforstyrring med tverrfagleg forvirring',
      strength: 'Kan levera eit heilt produkt åleine (og hate kvar einaste piksel)',
      weakness: 'Har googla \"er det for seint å bli noko anna\" minst 200 gangar',
