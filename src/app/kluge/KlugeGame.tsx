...
// ---------------------------------------------------------------------------
// Word pool — AI buzzwords, picked to be heard at any 2026 AI panel,
// demo day, or overpromised pitch. Mix of legitimate technical terms,
// fashion words, and the eye-rolly stuff that means everything and nothing.
// ---------------------------------------------------------------------------

const WORD_POOL = [
  // Foundation tech
  'LLM', 'GPT-5', 'Claude', 'Sonnet', 'Opus',
  'Gemini', 'Cursor', 'Copilot', 'ChatGPT', 'Anthropic',
  'OpenAI', 'NVIDIA', 'MCP', 'RAG', 'Embeddings',
  'Vector DB', 'Fine-tuning', 'Prompt engineering', 'Token', 'Context window',
  'Tool use', 'Agent', 'Agentic', 'Foundation model', 'Multimodal',
  'Transformer', 'Hallucination', 'Guardrails', 'Alignment', 'AGI',

  // Trends & buzzwords
  'Vibe coding', 'AI-native', 'AI-first', 'AI-powered', 'AI-driven',
  'Just a wrapper', '10x', 'Game-changer', 'Disruptive', 'Revolutionary',
  'Build with AI', 'Reasoning model', 'Singularity', 'Inference', 'GPU',

  // Pitch-deck classics
  'TAM', 'Hockey stick', 'Pre-seed', 'Burn rate', 'Runway',
  'Network effects', 'Killer app', 'Moat', 'Defensibility', 'Pivot',

  // Eye-roll
  'It thinks', 'Replace developers', 'Move fast', 'Ship it',
  '5x productivity', 'Picks and shovels', 'AI safety', 'Synergy',
]
...
export default function KlugeGame() {
  ...
  const intensity = Math.min((totalMarked - 1) / 24, 1)
      ...
      <section className="relative min-h-[calc(100vh-60px)] flex items-center justify-center bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-md mx-auto">
          ...
          <p className="font-satoshi text-gray-400 text-sm mb-8 leading-relaxed">
            ...
            <br />
            30 minutes on the clock. Card is randomised — refresh for a new one.
          </p>
          <button
            onClick={startGame}
      ...
      <section className={`min-h-[calc(100vh-60px)] bg-gray-900 flex flex-col relative overflow-hidden ${
        ...
        <div className="relative z-10 flex items-center justify-between px-4 py-2.5">
          <div className="flex items-center gap-2">
            <p className="font-mono text-[10px] tracking-[0.25em] uppercase text-gray-500">KLUGE</p>
        ...
        <div className="relative z-10 max-w-md mx-auto px-5 py-12 md:py-20">
          <div ref={boardRef} className="bg-gray-900 rounded-2xl p-6">
            <div className="text-center mb-6 motion-safe:animate-[fadeInUp_0.6s_ease-out_both]">
              ...
              <p className="font-satoshi text-gray-400 text-sm">
                You called it. The hype is real (or really tired).
              </p>
            </div>
          ...
          <div className="mt-6 text-center motion-safe:animate-[fadeInUp_0.6s_ease-out_0.4s_both]">
            <div className="bg-lime/10 border border-lime/20 rounded-2xl p-5 mb-5">
              <p className="text-base font-semibold text-lime mb-1.5">Bingo!</p>
              <p className="text-sm text-gray-300 font-satoshi leading-relaxed">
                Save the card and post it. Tag whoever was on stage.
              </p>
            </div>
            ...
            >
              Build with AI without the buzzwords →
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="text-center px-6 max-w-md mx-auto">
          <div className="mb-8">
            <Image
              ...
              alt="Kluge time-out illustration"
              width={200}
              height={200}
          ...
          <p className="font-satoshi text-gray-400 text-sm md:text-base mb-8">
            Either the panel was unusually grounded, or your card just wasn&apos;t ready.
          </p>
