...
readTime: "8 min read"
tags: ["Brand Strategy", "Marketing", "Storytelling", "Content"]
published: true
slug: "attention-is-new-gold"
---
...
<div style="background-color: #141416; border-radius: 16px; padding: 32px; margin: 32px 0; display: flex; flex-wrap: wrap; align-items: center; gap: 24px;">
  ...
  <div style="flex: 0 0 auto;">
    <img src="/images/attention-guide-promo.webp" alt="Attention Is New Gold — the founder's guide to brand & storytelling" style="width: 180px; border-radius: 8px;" />
  </div>
</div>
