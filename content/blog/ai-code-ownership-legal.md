...
faqs:
  - question: "Can I copyright code written by AI?"
    answer: "Generally no, at least not in the US or UK as of 2026. Copyright law in most jurisdictions requires a human author to create copyrightable work, and code generated entirely by an AI tool typically does not meet that threshold. However, code where a human exercised meaningful creative judgment — choosing the architecture, refining prompts, editing the output substantially — may be copyrightable in the human-contributed portions. The legal framework is still evolving rapidly, so document your human involvement throughout the build."
  - question: "Who owns code generated by Claude Code, Cursor, or GitHub Copilot?"
    answer: "Under the terms of service of most major AI coding tools (Anthropic for Claude, OpenAI for GPT-based tools, GitHub for Copilot), the user retains ownership of the output they generate, with limited claims by the provider. However, ownership is not the same as copyrightability — see above. Read the specific terms of service for the tool you use, and pay attention to clauses around training data, output license, and indemnification."
  - question: "Can AI-generated code accidentally copy someone else's work?"
    answer: "Yes, and it is a real risk. Large language models trained on public code repositories can sometimes reproduce passages of training data verbatim or near-verbatim, particularly for distinctive code patterns or licensed snippets. Tools like GitHub Copilot offer filtering to reduce this risk; Claude and other providers have similar safeguards. For commercial work, it is worth running AI-generated code through a code-similarity scanner before shipping, especially for distinctive utility functions or algorithms."
  - question: "What should a founder's AI code IP policy include?"
    answer: "Four elements: (1) which AI tools are approved for production code, (2) the license terms for each tool's output and any restrictions, (3) a logging requirement so the human contribution is documented, and (4) a similarity-scan or review step before AI-generated code ships. SmplCo includes this in the design and development process for every client product."
---
